...
<html>
    ...
    <body>
        ...
        <sql:query dataSource="${dataSource}" var="tipo">
            SELECT id_tarea, nombre from tarea where id_usuario_asignado = ${id}
        </sql:query> 
        <div class="main">
            ...
            <h1 class="w3layouts_head">Desglosar Tarea</h1>
            <div class="w3layouts_main_grid">
                <form action="../procesoTareaSub" method="POST" class="w3_form_post">
                    <div class="agileits_main_grid w3_agileits_main_grid">
                        <span class="wthree_grid">
                            <label>Tarea a desglosar<i>:</i></label>
                    ...
                    <div class="w3_agileits_main_grid w3l_main_grid">
                        <span class="agileits_grid">
                            ...
                            <input type="text" name="txtNombre" placeholder="Tarea 1.1" required="">
                        </span>
                    </div>
                    <div class="w3_main_grid">
                        <div class="w3_main_grid_right">
                            <input type="submit" name="btnAccion" value="Desglosar">
                        </div>
                    </div>
                </form>
            </div>
