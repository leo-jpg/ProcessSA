            ...
            <div id="wrapper">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div class="col-md-9">
                            <input type="text" name="txtUser" placeholder="Ej: Leotai" minlength="3" maxlength="15" required="" class="form-control"/>
                        </div>
                        <div class="col-md-1">
                    ...
                    <div>
                        ...
                        <div class="col-md-9">
                            <input type="text" name="txtRut" placeholder="Ej: 11111111-k" minlength="9" maxlength="10" required="" class="form-control" disabled/>
                        </div>          
                    </div>
                    <div>
                        <label class="col-md-2">
