...
<html lang="en">
    <head>
        ...
        <title>Agregar Unidad Interna</title>
            ...
            <div id="wrapper">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div class="col-md-9">
                            <input type="text" name="txtDescripcion" placeholder="Ej: RRHH" minlength="3" maxlength="21" required="" class="form-control"/>
                        </div>
                        <div class="col-md-1">
