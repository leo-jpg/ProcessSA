 ...
 * @author Franco
 */
public class CumplimientoDAO implements MetodosCRUD.Metodos<Tarea>{
    private static final String SQL_UPDATE = "{call sp_modificar_cump(?,?)}";
    ...
    public boolean update(Tarea generico) {
        ...
        try {
            ...
            pre.setInt(2, generico.getCumplimiento());
